...
rng_list = generate_random_numbers_normalRV_boxMuller(mu, sigma, rnd_count);
...
tic;
rng_list_boxMuller = generate_random_numbers_normalRV_boxMuller(mu, sigma, rnd_count);
toc;
